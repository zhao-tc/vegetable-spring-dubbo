...
import com.ztc.vegetable.manage.restful.comment.annotation.PassToken;
import com.ztc.vegetable.manage.restful.comment.annotation.UserLoginToken;
import com.ztc.vegetable.manage.restful.comment.bo.UserContext;
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object object) throws Exception {
        ...
        if (method.isAnnotationPresent(UserLoginToken.class)) {
            ...
            if (userLoginToken.required()) {
                ...
                User user = loginService.qryUserById(Integer.parseInt(userId));
                if (user == null) {
                    throw new RuntimeException("401");
                }
